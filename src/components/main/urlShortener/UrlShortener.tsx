import { useUrlShortener } from "features/hooks/urlShortener/useUrlShortener";
...
export const UrlShortener=()=>{
    const {handleSubmit,setShowModal,showModal,shortenedUrl}=useUrlShortener()
          ...
          <div className="w-full px-2">
                <form onSubmit={formik.handleSubmit}>
                    <div className="input-container w-full mx-auto lg:px-0 md:px-0 md:w-5/6 lg:w-4/6  relative">
                        ...
                        <button type="submit" className={`${formik.isSubmitting? 'loading ' : ''} btn border-0 cursor-pointer  short-btn text-white py-3 rounded-none rounded-tr-md rounded-br-md mt-1 transition-all hover:bg-violet-800 font-bold  px-3 bg-violet-600  `}>SHORTEN</button>
