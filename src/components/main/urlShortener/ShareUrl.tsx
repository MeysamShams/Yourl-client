...
export const ShareUrl=({shortenedUrl}:{shortenedUrl:string})=>{
    const [shareOption,setShareOption]=useState<ShareOption[]>()
    useEffect(()=>{
        const text="Created By YOURL :)"
        setShareOption([
                {
                    link:`https://t.me/share/url?url=${shortenedUrl}&text=${text}`,
                    icon:telgramIcon,
                    tooltip:"telegram"
                },
                {
                    link:`https://twitter.com/intent/tweet?url=${shortenedUrl}&text=${text}`,
                    icon:twitterIcon,
                    tooltip:"twitter"
                },
                {
                    link:`https://www.facebook.com/sharer/sharer.php?u=${shortenedUrl}`,
                    icon:facebookIcon,
                    tooltip:"telegram"
                },
                {
                    link:`https://www.linkedin.com/shareArticle?mini=true&url=${shortenedUrl}`,
                    icon:linkedinIcon,
                    tooltip:"linkedin"
                },
            ])
