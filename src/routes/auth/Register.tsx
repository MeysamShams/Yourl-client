        ...
        <div className="container mx-auto mt-28 px-4">
            <div className='w-full lg:w-96 md:w-4/6 bg-white p-5 mx-auto rounded-md'>
                ...
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <InputElement name='confirmPassword' value={formik.values.confirmPassword} errorMsg={formik.errors.confirmPassword} onChange={formik.handleChange} key={3} type="password" placeholder='Confirm password'/>
